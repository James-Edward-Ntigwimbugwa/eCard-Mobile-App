...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  List<MessageNotification> notifications = [
    MessageNotification(
      ...
      companyLogo: '🏢', // Replace with actual asset path
      timestamp: DateTime.now().subtract(const Duration(minutes: 30)),
      isRead: false,
      message: 'Your business card has been viewed',
    ),
    MessageNotification(
      id: '2',
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: HeaderBoldWidget(text: "Messages", color: Theme.of(context).highlightColor, size: '20'),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Lottie.network(
                            'https://assets2.lottiefiles.com/packages/lf20_V9t630.json', // Message/notification animation
                            fit: BoxFit.contain,
                          ),
                        ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Company name and card holder name row
                      Row(
                        children: [
                          Expanded(
                            child: Text(
